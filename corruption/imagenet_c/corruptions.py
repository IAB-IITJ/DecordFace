# adopted and modified from: https://github.com/hendrycks/robustness/blob/master/ImageNet-C/imagenet_c/imagenet_c/corruptions.py
# -*- coding: utf-8 -*-
...
def elastic_transform(image, severity=1):
    c = [(224 * 0.05, 224 * 0.01, 224 * 0.02),
         (224 * 0.065, 224 * 0.01, 224 * 0.02),
         (224 * 0.085, 224 * 0.01, 224 * 0.02),
         (224 * 0.1, 224 * 0.01, 224 * 0.02),
